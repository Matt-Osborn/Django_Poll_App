...
def vote(request, question_id):
    ...
    try:
        ...
        return render(
            ...
            {
                "question": question,
                "error_messge": "You didn't select a choice."
            }
        )
    else:
    ...
    ##redirect to the 'results' view--look into using reverse() in this manner 
    ##(you could test this by removing reverse() and seeing what happens